...
The `R` package `flippant` provides all functionality as well as data presented
here along with extensive additional documentation and example code accessible
from within `R` in an integrated manner.

The package is available as an `R` source package in the version current at
acceptance for publication in the supplementary material and may be installed
...
`https://bitbucket.org/graumannlabtools/flippant`.
