...
by user--provided minimal (`time_min_sec` ) and maximal (`time_max_sec`) time points
...
origin. The `split_by_experiment` argument is used to indicate whether independent
