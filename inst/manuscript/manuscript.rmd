...
```{r figure1_creation, echo = FALSE, fig.height = 4, fig.cap = "**`flippant`--based plotting of spectral traces underlying a subset of the data in Figure 4C--F from @ploier_dimerization_2016.** See text for command and details."}
# Plot spectral traces (Figure 1)
x <- tmpDir %>%
...
knitr::kable(
  ppr_results,
  row.names = FALSE,
  caption = "**Tabular output of `flippant`--based reanalysis of a subset of the data in Figure 4C--F from @ploier_dimerization_2016.** An plain text--version of this output is produced by calling `scramblase_assay_stats`.")
```
