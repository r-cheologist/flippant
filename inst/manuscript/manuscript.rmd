...
"Comprehensive `R` Archive Network" (CRAN). It is thus install-- and loadable as
follows from within a functional `R` environment:
...
Thirdly the code base and development history will, upon publication, be
