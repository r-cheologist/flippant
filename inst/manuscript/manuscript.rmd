...
title: '`flippant` --- An `R` package for the automated analysis of
  fluorescense--based scramblase assays'
...
typically measured using a fluorescence--based assay. While the assay has
yielded insight into the scramblase activity in crude membrane preparations,
...
functional validation of candidate scramblases [@menon_opsin_2011;@malvezzi_ca2-dependent_2013;@goren_constitutive_2014mohammadi_specificity_2014],
...
fluorimeter--generated spectrum, the amount of protein used to reconstitute 
...
point at which reductant is added in an experiment, potentialy resulting in
