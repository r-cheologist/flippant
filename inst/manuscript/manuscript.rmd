...
`wmtsa` `R` package [@percival_wavelet_2000;@constantine_wmtsa:_2013]. The 
acquisition time is reset such that the zero time point henceforth corresponds 
to the time of addition. 
