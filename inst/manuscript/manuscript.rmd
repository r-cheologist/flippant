...
#Installation, Input Requirements and Main Features
##Installation
...
default used when ommited, supporting the user in providing the data needed in 
one table row per data point.
```{r echo = FALSE, comment = ""}
make.usage.section("scramblaseAssayInputTemplate", env = asNamespace("flippant"))
```
...
```{r echo = FALSE, comment = ""}
make.usage.section("scramblaseAssayTraces", env = asNamespace("flippant"))
```

##Producing Protein To Phospholipid (PPR) Plots
```{r echo = FALSE, comment = ""}
make.usage.section("scramblaseAssayPlot", env = asNamespace("flippant"))
```

##Non-graphical Output of Analysis Results
```{r echo = FALSE, comment = ""}
make.usage.section("scramblaseAssayStats", env = asNamespace("flippant"))
```
