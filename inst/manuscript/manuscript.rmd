...
Based on @menon_opsin_2011 and @goren_constitutive_2014 and largly keeping with
...
$\alpha$, which implies all liposomes on average carrying one scramblase and 63%
have one or more [i.e. are active; @goren_constitutive_2014]. The behavior of the 
