...
```{r, code=formatR::usage('scramblase_assay_input_template'), eval=FALSE}
```
...
```{r, code = formatR::usage('scramblase_assay_traces'), eval = FALSE}
```
...
```{r, code = formatR::usage('scramblase_assay_plot'), eval = FALSE}
```
...
```{r, code = formatR::usage('scramblase_assay_stats'), eval = FALSE}
```
