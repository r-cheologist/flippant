...
supports both the original (@menon_opsin_2011; @goren_constitutive_2014; `generation_of_algorithm = 1`), as well as the more recent iteration (@ploier_perturbed_submitted; default; `generation_of_algorithm = 2`), which
