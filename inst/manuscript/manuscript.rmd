...
of nitrobenzoxadiazole (NBD) labeled fluorescent lipids.
...
determination of when dithionite was added to the sample using peak detection by
continuous wavelet transformation as implemented by the `wmtsa` `R` package 
[@percival_wavelet_2000;@constantine_wmtsa:_2013] and resetting the acquisition 
time accordingly. The zero time point henceforth corresponds to the time of 
addition. 
