...
by `scramblase_assay_plot` in a call to `scramblaseAssayStats`, this is achieved
and produces tabular output represented in Table 1.

```{r, eval = FALSE}
# Write out results in tabular manner (Table 1)
scramblaseAssayStats("inputTable.txt", generation_of_algorithm = 1, splitByExperiment = FALSE)
```

```{r, echo = FALSE}
ppr_results <- scramblaseAssayStats(x, generation_of_algorithm = 1, splitByExperiment = FALSE)
