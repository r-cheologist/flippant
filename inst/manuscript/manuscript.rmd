...
§
:   Current Address: Scientific Service Group Biomolecular Mass Spectrometry, Max Planck Institute for Heart and Lung Research, W.G. Kerckhoff Institute, Ludwigstr. 43, D--61231 Bad Nauheim, Germany
...
extract the data files, stored in a ZIP archive within the package.
...
Upon acceptance of the manuscript, `flippant` will be deposited as a
self--contained `R` package including all data presented in the `Bioconductor`
collection of tools for biomedical data analysis [@huber_orchestrating_2015].
