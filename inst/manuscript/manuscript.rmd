...
data underlying Figure 4C--F in @ploier_dimerization_2016. The first step is to
extract the data files, stored in a ZIP archive within the pacakge.
...
experimental series (Figure 1). Note
...
```{r figure1_creation, fig.height = 4, fig.cap = "**`flippant`--based plotting of spectral traces underlying a subset of the data in Figure 4C--F from @ploier_dimerization_2016.** See text for command and details."}
